        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
          ...
          <div className="lg:col-span-8 font-sans text-brand-dark leading-relaxed">
            ...
            <div className="mb-8 border-b border-gray-200 pb-6">
              <span className="block text-brand-green font-bold text-sm tracking-widest uppercase mb-2">AGRAR-WIRTSCHAFT | TRENDS 2025</span>
              <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6 text-gray-900">
                Trendwende auf dem Acker: Warum immer mehr Solar-Verpächter ihre Verträge jetzt zu Geld machen – die 5 häufigsten Gründe
              </h1>
              <h2 className="text-xl md:text-2xl text-gray-600 leading-relaxed font-serif">
                Statt 20 Jahre auf jährliche Pacht zu warten, entscheiden sich hunderte Grundbesitzer für eine sofortige Auszahlung. Was treibt diesen Ansturm? Eine Analyse der fünf häufigsten Motive.
              </h2>
            </div>
