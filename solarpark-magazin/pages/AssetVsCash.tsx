        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16">
          ...
          <div className="lg:col-span-8 font-sans text-brand-dark leading-relaxed">
            ...
            <div className="mb-8 border-b border-gray-200 pb-6">
              <span className="block text-brand-green font-bold text-sm tracking-widest uppercase mb-2">MARKT & FINANZEN | SPEZIAL</span>
              <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6 text-gray-900">
                Bodenpreise rennen davon, Pacht tröpfelt hinterher: Warum "Warten" für Solar-Verpächter jetzt zum Verlustgeschäft wird
              </h1>
              <h2 className="text-xl md:text-2xl text-gray-600 leading-relaxed font-serif">
                Analyse: Auf dem Papier sind Solarpachtverträge inflationsgeschützt. Doch in der Realität steigen die Preise für Ackerland und Immobilien oft doppelt so schnell wie die Indexierung der Pacht. Wer sein Kapital 20 Jahre im Vertrag liegen lässt, verliert massiv an Kaufkraft. Immer mehr Eigentümer nutzen deshalb die "Pacht-Kapitalisierung".
              </h2>
            </div>
